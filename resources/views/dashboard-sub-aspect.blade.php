            ...
            <div class="body-wrapper ">
                ...
                <section style="height: 100vh;" class="right-side px-5 pt-4">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <a href="/add-sub-aspect/{{ $dataAspect->id }}" class="me-2">
                                    <button class="btn btn-primary">Buat Sub Aspek Baru</button>
                                </a>
                            </div>
                        </div>
                        <div class="row mb-3 mt-3">
                            @foreach ($dataSubAspect as $data)
                                @if ($data->id_aspects == $dataAspect->id)
                                    <div class="col-4 mb-4">
                                        <div class="cardz-wrapper">
                                            <label>Nama Sub Aspek</label>
                                            <p>{{ $data->name }}</p>
                                            <div class="d-flex justify-content-start mt-3">
                                                <a href="/edit-sub-aspect/{{ $data->id . '/' . $dataAspect->id }}">
                                                    <button type="button"
                                                        class="btn btn-secondaryz me-1">Edit</button>
                                                </a>
                                                <a href="/delete-sub-aspect/{{ $data->id . '/' . $dataAspect->id }}">
