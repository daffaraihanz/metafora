        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper ">
                ...
                <section style="height: 100vh;" class="right-side px-5 pt-4">
                    <form action="/question-edit/{{ $dataQuestion->id . '/' . $dataQuestionPackage->id }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="questionName" class="form-control" id="exampleFormControlTextarea1" rows="4">{{ $dataQuestion->name }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
