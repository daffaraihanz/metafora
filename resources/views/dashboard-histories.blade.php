    ...
    <section class="dashboard-request">
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                    ...
                    <div>
                        ...
                        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                            <ul id="sidebarnav">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link active" href="/dashboard-completed" aria-expanded="false">
                                        <span>
                                            <i class="ti ti-layout-dashboard"></i>
                                        </span>
            ...
            <div class="body-wrapper ">
                ...
                <section
                    @if (count($dataTestScoreAll) > 3) style="padding-bottom: 200px;" @else  style="height: 100vh;" @endif
                    ...
                    <div class="container">
                        ...
                        <div class="row cardz-wrapper mb-3 align-items-center mb-3">
                            <div class="col-1">
                                <div style="background: {{ $dataUserTestScore->aspect_colors }};"
                                    class="color-identity"></div>
                            </div>
                            <div class="col-2">
                                <label>Nama Aspek</label>
                                <p>{{ $dataUserTestScore->aspect_names }}</p>
                            </div>
                            <div class="col-2">
                                <label>Score Didapatkan</label>
                                <p>{{ $dataUserTestScore->total_score }}</p>
                            </div>
                            <div class="col-6 ">
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex">
                                    @foreach ($dataSubAspect as $data)
                                        <p class="me-3 sub-aspect">{{ $data->name }}</p>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 mb-2">
                            <div class="col-12">
                                <h5>Perolehan Skor Keseluruhan Aspek</h5>
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center mb-3 mt-3">
                            @foreach ($dataTestScoreAll as $data)
                                <div class="col-6 mb-3">
                                    <div class="cardz-wrapper">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="d-flex align-items-center">
                                                    <div style="background: {{ $data->aspect_colors }}; width:20%;"
                                                        class="color-identity me-3">
                                                    </div>
                                                    <div>
                                                        <label>Nama Aspek</label>
                                                        <p>{{ $data->aspect_names }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <label>Score Didapat</label>
                                                        <p>{{ $data->total_score }}</p>
                                                    </div>
                                                    <div style="padding-right:200px;">
                                                        <label>Score Maksimal</label>
                                                        <p>{{ $data->aspect_total_scores }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row mt-4 mb-2">
                            <div class="col-12">
                                <h5>Rincian Jawaban Soal</h5>
                            </div>
                        </div>
                        @foreach ($dataQuestionHistory as $data)
                            <div
                                class="row cardz-wrapper mb-3 align-items-center  justify-content-between question-wrapper">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p> {{ $loop->iteration }}. {{ $data->name }}</p>
                                    </div>
                                    <hr>
                                    @foreach ($dataAnswerHistory as $dataAns)
                                        @if ($dataAns->name_question == $data->name)
                                            <div class="d-flex align-items-c\enter justify-content-between">
                                                <div class="answer-wrapper d-flex mb-2 align-items-center">
                                                    <p> {{ $dataAns->name }}</p>
                                                    @foreach ($dataAspect as $dataSub)
                                                        @if ($dataSub->id == $dataAns->id_aspects)
                                                            <p
                                                                style="background: {{ $dataSub->color }};margin-right:20px">
                                                                {{ $dataAns->score }}
                                                            </p>
                                                        @endif
                                                    @endforeach
                                                    @foreach ($dataUserTestData as $dataUse)
                                                        {{-- {{ $dataAns->id_aspects }} --}}
                                                        @if (
                                                            $dataUse->id_answer_histories == $dataAns->id &&
                                                                $dataRegistration->id == $dataUse->id_registration &&
                                                                $dataUse->id_aspects != 0 &&
                                                                $dataUse->id_aspects == $dataAns->id_aspects)
                                                            <p>Jawaban Terpilih</p>
                                                        @endif
                                                    @endforeach
                                                </div>
                                            </div>
