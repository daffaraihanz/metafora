        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper ">
                ...
                <section style="height: 100vh;" class="right-side px-5 pt-4">
                    <form action="/dashboard-question-package-edit/{{ $dataQuestionPackage->id }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Paket Soal</label>
                                    <input name="name" type="text" class="form-control"
                                        id="exampleInputEmail1" value="{{ $dataQuestionPackage->name }}"
                                        aria-describedby="emailHelp">
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Harga Paket Soal</label>
                                    <input name="price" type="number" class="form-control"
                                        value="{{ $dataQuestionPackage->price }}" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Waktu Pengerjaan
                                        <span class="text-warning">( Menit )</span></label>
                                    <input type="text" name="end_timer" class="form-control"
                                        value="{{ $dataQuestionPackage->end_timer }}" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
