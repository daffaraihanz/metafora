        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper ">
                ...
                <section style="height: 100vh;" class="right-side px-5 pt-4">
                    <form action="/update-sub-aspect/{{ $dataSubAspect->id . '/' . $dataAspect->id }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Sub Aspek</label>
                                    <input name="name" value="{{ $dataSubAspect->name }}" type="text"
