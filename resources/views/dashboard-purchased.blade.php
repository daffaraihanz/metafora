                    ...
                    <div>
                        ...
                        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                            <ul id="sidebarnav">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link active" href="/dashboard-purchased" aria-expanded="false">
                                        <span>
                                            <i class="ti ti-layout-dashboard"></i>
                                        </span>
            ...
            <div class="body-wrapper ">
                ...
                <section
                    ...
                    @foreach ($dataUser as $data)
                        @if ($data->flag_journey == 'Pembayaran Berhasil')
                            <div class="row cardz-wrapper mb-3 align-items-center mb-3">
                                ...
                                <div class="col-6">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="/generate-confirmation/{{ $data->id }}">
                                                <button type="button" class="btn btn-primary">Generate Soal</button>
                                            </a>
                                            <a href="/delete-data-purchased/{{ $data->id }}">
