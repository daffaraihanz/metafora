    ...
    <section class="dashboard-request">
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                    ...
                    <div>
                        ...
                        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                            <ul id="sidebarnav">
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link active" href="/dashboard-forgot" aria-expanded="false">
                                        <span>
                                            <i class="ti ti-layout-dashboard"></i>
                                        </span>
            ...
            <div class="body-wrapper ">
                ...
                <section
                    @if (count($dataForgot) > 3) style="padding-bottom: 200px;" @else  style="height: 100vh;" @endif
                    class="right-side px-5 pt-4">
                    @foreach ($dataForgot as $data)
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a style="width: 100%;" target="_blank"
                                                href="https://wa.me/62{{ $data->whatsapp }}?text=Berikut%20adalah%20Kode%20Verifikasi%20untuk%20memperbarui%20password%20(%20%20)">
                                                <button style="width: 100%;" type="button"
                                                    class="btn btn-secondaryz">Kirim Pesan</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
