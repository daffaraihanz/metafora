        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper ">
                ...
                <section style="height: 100vh;" class="right-side px-5 pt-4">
                    <form action="/add-question-package" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Waktu Pengerjaan</label>
                                    <input type="datetime-local" name="end_timer" class="form-control" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
